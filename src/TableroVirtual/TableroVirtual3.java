...
//Comunicacion comuni = new Comunicacion();
    ...
    JLabel Estacion = new JLabel("Jugador:");
    ...
    public TableroVirtual3(byte[] envio) {
        super();
        enviolocal = envio;
        setLayout(null);
        ...
        JLabel background = new JLabel(new ImageIcon("C:\\Users\\admin\\Desktop\\Proyecto Redes\\tablero3.jpg"));
...
//     estacion(lblEstacion);
    ...
    public void main(String args[]) throws Throwable {
        ...
        new TableroVirtual3(enviolocal);
    }
