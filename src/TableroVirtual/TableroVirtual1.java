...
//Comunicacion comuni = new Comunicacion();
    ...
    JLabel lblEstacion = new JLabel("");
       ...
       JLabel BPosition = new JLabel(new ImageIcon("C:\\fichas2.png"));
    JLabel APosition = new JLabel(new ImageIcon("C:\\fichasaz.png"));
    JLabel CPosition = new JLabel(new ImageIcon("C:\\fichasn.png"));
    JLabel DPosition = new JLabel(new ImageIcon("C:\\fichasv.png"));
    ...
    public TableroVirtual1(byte[] envio) {
        ...
        JLabel background2 = new JLabel(new ImageIcon("C:\\fondoPrueba.jpg"));
        background2.setBounds(0, 0, 800, 800);
        add(background2);
        
        JLabel background = new JLabel(new ImageIcon("C:\\tablero1.jpg"));
        background.setBounds(0, -10, 600, 940);
        background2.add(background);

        JLabel background3 = new JLabel(new ImageIcon("C:\\serpientes_escaleras.jpg"));
