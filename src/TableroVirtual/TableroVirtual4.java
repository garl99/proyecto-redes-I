...
//Comunicacion comuni = new Comunicacion();
    ...
    public TableroVirtual4(byte[] envio) {
        super();
        enviolocal = envio;
        setLayout(null);
        ...
        JLabel background = new JLabel(new ImageIcon("C:\\Users\\admin\\Desktop\\Proyecto Redes\\tablero4.jpg"));
        background.setBounds(0, -10, 490, 605);
...
//     estacion(lblEstacion);
    ...
    public void main(String args[]) throws Throwable {
        ...
        new TableroVirtual4(enviolocal);
    }
